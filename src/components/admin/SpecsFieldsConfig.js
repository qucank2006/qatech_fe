...
export const specsFieldsConfig = {
  ...
  laptop: [
    ...
    { name: 'gpuType', label: 'Card đồ họa', placeholder: 'VD: NVIDIA RTX 4060', multiline: true },
    ...
    { name: 'screenTechnology', label: 'Công nghệ màn hình', placeholder: 'VD: IPS, 144Hz', multiline: true },
    { name: 'os', label: 'Hệ điều hành', placeholder: 'VD: Windows 11 Home' },
    { name: 'battery', label: 'Pin', placeholder: 'VD: 56WHrs, 3 cell' },
    { name: 'ports', label: 'Cổng kết nối', placeholder: 'VD: 2x USB 3.2, 1x HDMI, 1x Type-C', multiline: true }
  ],
  ...
  'parts-gpu': [
    ...
    { name: 'ports', label: 'Cổng xuất hình', placeholder: 'VD: 3x DP 1.4a, 1x HDMI 2.1', multiline: true },
  ...
  monitor: [
    ...
    { name: 'ports', label: 'Cổng kết nối', placeholder: 'VD: HDMI 2.0, DisplayPort 1.4, USB 3.0', multiline: true },
