        ...
        <div className="lg:col-span-2 space-y-4">
          {
            items.map((item) => {
              ...
              const itemStock = item.stock || item.product?.stock;
              
              return (
                <div key={itemId} className="bg-[#151515] border border-neutral-800 rounded-xl p-4 hover:border-neutral-700 transition-colors">
                  <div className="flex gap-4">
                    {/* Hình ảnh sản phẩm */}
                    <Link to={`/product/${itemSlug || itemId}`} className="shrink-0">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          {itemStock !== undefined && (
                            <span className={`text-xs px-2 py-1 rounded ${
                              ...
                              {itemStock > 0 ? `Còn ${itemStock}` : 'Hết hàng'}
                            </span>
                          )}
                        </div>
                      </div>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <div className="flex items-center border-2 border-neutral-700 rounded-lg overflow-hidden bg-neutral-900 hover:border-indigo-500/50 transition-colors">
                            ...
                            <button 
                              ...
                              disabled={itemStock ? item.quantity >= itemStock : false}
                              className="px-3 py-2 text-white hover:bg-neutral-800 disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
                          ...
                          <span className="text-neutral-400 text-sm ml-2">
                            = <span className="text-white font-bold">{((itemPrice || 0) * item.quantity).toLocaleString('vi-VN')}đ</span>
                          </span>
                        </div>
