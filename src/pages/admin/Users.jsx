...
const Users = () => {
  ...
  const handleStatusChange = async (userId, currentStatus) => {
    ...
    const actionText = isActive ? 'chặn' : 'bỏ chặn';
    const confirmMessage = isActive 
      ? `Bạn có chắc chắn muốn chặn người dùng này?\n\nKhi bị chặn:\n• Không thể đăng nhập mới\n• Token hiện tại sẽ bị vô hiệu hóa ở request tiếp theo\n• Không thể reset password\n• Không thể tạo OTP`
      : `Bạn có chắc chắn muốn bỏ chặn người dùng này?\n\nKhi được bỏ chặn, người dùng có thể đăng nhập lại bình thường.`;
            ...
            <table className="w-full text-left">
              ...
              <tbody className="divide-y divide-neutral-800">
                {users.map((user) => {
                  ...
                  // Kiểm tra isActive: true hoặc không có status 'Blocked'
                      ...
                      <td className="px-6 py-4">
                        <div className="flex justify-end gap-2">
                          <button 
                            ...
                            title={
                              isActive 
                                ? 'Chặn người dùng: Không thể đăng nhập, token sẽ bị vô hiệu hóa, không thể reset password'
                                : 'Bỏ chặn người dùng: Cho phép đăng nhập lại bình thường'
                            }
                          >
